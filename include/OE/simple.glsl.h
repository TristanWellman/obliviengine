...
/*
    ...
    void main()
    {
        ...
        frag_color = vec4((((ambient + diffuse) + specular) * vec3(color.xyz)) * texture(_texture_smp, texcoord).xyz, color.w);
    }

*/
#if defined(SOKOL_GLCORE)
static const uint8_t fs_source_glsl410[1148] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x75,0x6e,
    ...
    0x65,0x78,0x63,0x6f,0x6f,0x72,0x64,0x29,0x2e,0x78,0x79,0x7a,0x2c,0x20,0x63,0x6f,
